...
<?oracle-xsl-mapper
  ...
  <mapTargets>
    <target type="WSDL">
      <schema location="../manageInventory.wsdl"/>
      <rootElement name="StoreRequest" namespace="http://www.example.org/ns/store"/>
    </target>
  </mapTargets>
  <!-- GENERATED BY ORACLE XSL MAPPER 11.1.1.7.0(build 130301.0647.0008) AT [WED DEC 13 09:01:25 PST 2017]. -->
?>
<xsl:stylesheet version="1.0"
                ...
                xmlns:ns3="http://xmlns.oracle.com/POApp/internalStore/manageInventory"
                ...
                exclude-result-prefixes="xsi xsl wsdl plnk client ns0 xsd ns1 ns2 ns3 xp20 bpws bpel bpm ora socket mhdr oraext dvm hwf med ids xdk xref bpmn ldap">
  <xsl:template match="/">
    <ns2:StoreRequest>
