...
<?oracle-xsl-mapper
  ...
  <!-- GENERATED BY ORACLE XSL MAPPER 11.1.1.7.0(build 130301.0647.0008) AT [WED DEC 06 09:00:04 PST 2017]. -->
?>
<xsl:stylesheet version="1.0"
                ...
                exclude-result-prefixes="xsi xsl wsdl inp1 xsd tns plt ns0 jca xp20 bpws bpel bpm ora socket mhdr oraext dvm hwf med ids xdk xref bpmn ldap">
  <xsl:template match="/">
    <inp1:order>
      <inp1:customerId>
